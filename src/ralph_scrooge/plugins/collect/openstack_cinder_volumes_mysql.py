...
If you want to charge tenant for usage of volume but volume size is not relevant
add volume type name to OPENSTACK_CINDER_VOLUMES_DONT_CHARGE_FOR_SIZE if
settings file.
"""
...
class CinderVolumesPlugin(OpenStackBasePlugin):
    ...
    def get_usages(self, *args, **kwargs):
        ...
        for (
            ...
            # Volume type is fetched from volume_types table or from hostname of
            # volumes.host if volume type is NULL
