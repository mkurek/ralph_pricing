...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DailyUsage', fields ['date']
        db.create_index(u'ralph_scrooge_dailyusage', ['date'])


    def backwards(self, orm):
        # Removing index on 'DailyUsage', fields ['date']
        db.delete_index(u'ralph_scrooge_dailyusage', ['date'])
