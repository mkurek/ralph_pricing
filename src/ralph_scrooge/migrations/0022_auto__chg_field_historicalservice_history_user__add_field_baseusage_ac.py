...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistoricalService.history_user'
        db.alter_column('ralph_scrooge_historicalservice', u'history_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))
        # Adding field 'BaseUsage.active'
        db.add_column(u'ralph_scrooge_baseusage', 'active',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HistoricalService.history_user'
        db.alter_column('ralph_scrooge_historicalservice', u'history_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Deleting field 'BaseUsage.active'
        db.delete_column(u'ralph_scrooge_baseusage', 'active')
